...
#SBATCH -J tabnet
#SBATCH --output=slurm_out/linear_out.%j
#SBATCH --error=slurm_out/linear_err.%j
...
SCRIPT="/dss/dsshome1/04/di93zer/git/cellnet/scripts/py_scripts/train_linear.py"
GIT_REPO="/dss/dsshome1/04/di93zer/git/cellnet"
ARGS="--version=version_1--epochs=20"
